...
namespace EFCore.DTO.Wrapper.Tests.Extensions;

public static class DBCommandExtensions
{
    public static async Task AddPerson(this DbCommand cmd, int id, string firstName, string lastName, 
                                        (AddressType Type, string AddressLine1, string AddressLine2, string PostalCode, string City, string Country, bool IsCurrent)[]? addresses = null)
    {
